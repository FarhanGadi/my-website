      ...
      <div name="hero" className=" w-full h-screen bg-[#0a192f]">
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
          ...
          <p className="text-[#8892b0] py-4 max-w-[700px]">
            ...
            designing) excetional digital experiences. Currently, I'm focused on
            building responsive full-stack web applications.
          </p>
          <div>
            <button className="text-white group border-2 px-5 py-2 flex items-center hover:bg-pink-600 hover:border-pink-600">
              View Work
